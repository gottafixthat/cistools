/**
 * Cfg.cpp - A _very_ simple interface to config files.
 *
 * A config file consists of multiple lines with keywords on the left,
 * an equals sign, and the values on the right.
 * Whitespace will be stripped from the beginning and end of the lines.
 *
 **************************************************************************
